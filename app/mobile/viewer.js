...
var __PDF_APP = {
  ...
  initUI: function pdfViewInitUI() {
    ...
    document.getElementById('pageNumber').addEventListener('change',
        function() {
      __PDF_APP.page = (this.value | 0);

      // Ensure that the page number input displays the correct value, even if the
      // value entered by the user was invalid (e.g. a floating point number).
      if (this.value !== __PDF_APP.page.toString()) {
        this.value = __PDF_APP.page;
      }
    });
    ...
    container.addEventListener('pagechange', function (evt) {
      ...
      var numPages = __PDF_APP.pagesCount;
...
(function animationStartedClosure() {
  ...
  __PDF_APP.animationStartedPromise = new Promise(
    function (resolve) {
...
__PDF_APP.animationStartedPromise.then(function () {
  var fileParam = getParameterByName('file');
  if (!fileParam) {
    fileParam = DEFAULT_URL;
  }

  __PDF_APP.open({ url: fileParam});
});
